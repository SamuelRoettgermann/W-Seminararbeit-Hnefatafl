...
public class ZUG_MASCHINE_SCHWER extends ZUG {

	int anzahl = 0;
	int tiefe;


	public ZUG_MASCHINE_SCHWER(String team) {
		super(team);
		felderberechnet = 0;
		richtungberechnet = "x";
	...
	/*
	 * Schwarz maximiert immer und weiß minimiert immer
	 * Evtl. muss noch gefixt werden, dass nicht nur true oder false für geschlagen ausgegeben werden kann, sondern auch, wie viele Figuren geschlagen wurden (GEFIXT)
	 */
	public int Auswertung(ARD_RI_TAFL spiel, int geschlagen, String team) {
		...
		if(spiel.getFigurtyp(2, 0).equals("Schwede") && spiel.getFigurtyp(0, 2).equals("Schwede")) {
		...
		if(spiel.getFigurtyp(0, 1).equals("Russe")) {
			auswertung = auswertung - 20;
		}
		if(spiel.getFigurtyp(0, 5).equals("Russe")) {
			auswertung = auswertung - 20;
		}
		if(spiel.getFigurtyp(5, 0).equals("Russe")) {
			auswertung = auswertung - 20;
		}
		if(spiel.getFigurtyp(6, 1).equals("Russe")) {
			auswertung = auswertung - 20;
		}
		if(spiel.getFigurtyp(1, 6).equals("Russe")) {
			auswertung = auswertung - 20;
		}
		if(spiel.getFigurtyp(6, 5).equals("Russe")) {
			auswertung = auswertung - 20;
		}
	...
	public static void main(String[] args) {
		ZUG_MASCHINE_SCHWER s = new ZUG_MASCHINE_SCHWER("schwarz");
